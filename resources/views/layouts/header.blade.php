    ...
    <nav class="navbar bg-blackDark navbar-top-default navbar-expand-lg static-nav  nav-bottom-line">
        <div class="container">
            <a class="logo" href="javascript:void(0)">
                ...
                {{-- <h2>TRC</h2> --}}
                <img src="consulting/img/logo.png" alt="The Restaurant Consultant" title="The Restaurant Consultant" class="logo-default">
            ...
            <a href="#request" class="scroll btn-setting btn-scale btn-green text-white d-none d-lg-block">Book a Call</a>
